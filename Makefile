...
test-integration:
	$(GO) test -count=1 -tags=integration ./internal/authorization ./internal/catalog ./internal/database ./internal/ingestion ./internal/jobqueue ./internal/processing/importjob
